...
students, gender, preference, average_grade, course, premium, walking_speed = multidict({
    ...
    "Hanna": ["d", ["m", "w", "d"], 2.7, "Business Administration and Engineering - Mechanical Engineering", False, 5],
    "Mia": ["w", ["m"], 3.0, "Mathematics", False, 5.6],
    "Lelli": ["w", ['m'], 1.3, "Business Administration", False, 5.5],
    "Sofia": ["w", ["w", "d"], 2.3, "Computer Science", False, 4.5],
    "Lina": ["w", ["m"], 3.3, "Linguistics and communication sciences", False, 5],
    "Mila": ["w", ["m"], 3.7, "Biology", False, 5],
    "Tanja": ["w", ["m"], 3.7, "Biology", False, 4.9],
    "Lea": ["w", ["m"], 2.0, "Computer Science", False, 5.1],
    "Marie": ["d", ["d"], 3.7, "Chemistry", False, 5.2],
    "Ella": ["w", ["m"], 2.4, "Applied Geosciences", False, 4.7],
    "Ben": ["m", ["m", "d"], 3.3, "Mathematics", False, 6],
    "Leon": ["m", ["w"], 1.0, "Business Administration", False, 4.8],
    "Paul": ["d", ["d", "m"], 3.7, "Computer Science", False, 5.5],
    "Jonas": ["m", ["w"], 3.3, "Business Administration and Engineering - Electrical Power Engineering", False, 4.5],
    ...
    "Günther": ["m", ["w"], 1.7, "Mechanical Engineering", False, 5.5],
    "Frank": ["m", ["w"], 1.7, "Mechanical Engineering", False, 4.5],
})
